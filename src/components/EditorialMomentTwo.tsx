...
export const EditorialMomentTwo: React.FC = () => {
  return (
    <section className="relative w-full py-24 sm:py-32 md:py-40 px-6 flex flex-col items-center justify-center text-center overflow-hidden z-10">
      {/* Fotografia surgindo pela esquerda */}
      <ScrollRevealPhoto
        photoUrl={REAL_PHOTOS[2].url}
        position="left"
        targetOpacity={0.65}
        slideDistance={45}
      />
      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-4 sm:space-y-5">
        ...
        >
          Peças para criar combinações que têm tudo a ver com você.
        </motion.p>
      </div>
    </section>
  );
